...
public class AGG {
    ...
    public AGG(int tamanioPoblacion, double Pc, double Pm,int cruce, int genes,Random rnd){
    ...
    public double[] AGG(String trainingFile, String testFile, int K, int metricType, ArrayList<TrainRecord> trainingSet,int ptest,String alg) throws IOException, CloneNotSupportedException{
    ...
    public void cruce(){
        this.P = cruce.cruce(this.P, this.Pc,rnd);
    }
