...
public class AM_1_01 {
    ...
    public AM_1_01(int tamanioPoblacion, double Pc, double Pm,int cruce, int genes,Random rnd){
    ...
    public double[] AM_1_01(String trainingFile, String testFile, int K, int metricType, ArrayList<TrainRecord> trainingSet,int ptest,String alg) throws IOException, CloneNotSupportedException{
