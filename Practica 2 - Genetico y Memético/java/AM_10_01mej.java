...
public class AM_10_01mej {
    ...
    public AM_10_01mej(int tamanioPoblacion, double Pc, double Pm,int cruce, int genes,Random rnd){
    ...
    public double[] AM_10_01mej(String trainingFile, String testFile, int K, int metricType, ArrayList<TrainRecord> trainingSet,int ptest,String alg) throws IOException, CloneNotSupportedException{
